...
export default function UserBitHistoryPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const marketData = await fetchMarkets(); // Fetch users from the function
  ...
  return (
    <Container>
      <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5}>
        <Typography variant="h4">Winning Report</Typography>
        ...
        <Box sx={{ width: '100%', maxWidth: { xs: '100%', sm: 180 }, mb: { xs: 2, sm: 2 } }}>
          <FormControl fullWidth>
            ...
            >
              ...
              <MenuItem value="double-digit">Dauble Digit</MenuItem>
              ...
              <MenuItem value="sp-dp-tp">SP DP TP</MenuItem>
              <MenuItem value="sp-mortor">Full Sangum</MenuItem>
              <MenuItem value="dp-mortor">Full Sangum</MenuItem>
              <MenuItem value="double-even-odd">Double Enen Odd</MenuItem>
            </Select>
          </FormControl>
        </Box>
