...
export default function UserBitHistoryPage() {
  ...
  const downloadPDF = () => {
    ...
    const columns = [
      ...
      { header: 'Left Digit', dataKey: 'open_digit' },
      { header: 'Right Digit', dataKey: 'close_digit' },
    ...
    doc.save('user_bid_history_gali.pdf');
  };

  return (
    <Container>
      <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5}>
        <Typography variant="h4">Gali-Di-Sawar User Bid History</Typography>
      ...
      >
        ...
        <Autocomplete
          ...
          getOptionLabel={(option) => `${option.title} (${convertTime(option.close_time)})`}
