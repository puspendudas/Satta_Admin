        ...
        <Box sx={{ p: 2 }}>
          <form onSubmit={handleSubmit}>
            {renderAutocomplete(
              ...
              openPannaInputValue,
              setOpenPannaValue,
              setOpenPannaInputValue,
              (option) => option.panna,
              'panna'
            )}
            <Stack direction="row" spacing={2} />
            {renderDigitAutocomplete(
              'open_digit',
              'Open Digit',
              fullDigit,
              openDigitValue,
            ...
            {renderDigitAutocomplete(
              ...
              fullDigit,
              closeDigitValue,
              closeDigitInputValue,
              setCloseDigitValue,
              setCloseDigitInputValue
            )}
            <Stack direction="row" spacing={2} />
            {renderAutocomplete(
              'close_panna',
              ...
              fullList,
              closePannaValue,
              closePannaInputValue,
              setClosePannaValue,
              setClosePannaInputValue,
              (option) => option.panna,
              'panna'
            )}
            <Stack direction="row" spacing={2} />
