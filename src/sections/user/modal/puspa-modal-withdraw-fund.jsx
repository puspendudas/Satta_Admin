...
export default function PuspaModalWithDrawFund({ isOpen, onClose, userIdData, name }) {
    ...
    <Modal open={isOpen} onClose={onClose}>
      ...
      >
        ...
        >
          ...
          WithDraw {name ? capitalizeString(name) : 'User'}&apos;s Fund
          </Typography>
          {/* Close button */}
...
PuspaModalWithDrawFund.propTypes = {
