  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setMarkets(
          marketData.filter((market) => market.market_status === true && market.status === true)
        );
      } catch (err) {
        // console.log(err);
      }
        ...
        <Box sx={{ width: '100%', maxWidth: { xs: '100%', sm: 180 }, mb: { xs: 2, sm: 2 } }}>
          <FormControl fullWidth>
            ...
            >
              ...
              <MenuItem value="sp-mortor">SP Mortor</MenuItem>
              <MenuItem value="dp-mortor">DP Mortor</MenuItem>
              <MenuItem value="double-even-odd">Double Even Odd</MenuItem>
            </Select>
          </FormControl>
        </Box>
