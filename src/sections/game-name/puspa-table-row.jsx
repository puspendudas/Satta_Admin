  ...
  return (
    <>
      <TableRow className="responsive-table">
        ...
        <TableCell data-label="Hindi Name">{name_hindi}</TableCell>

        <TableCell data-label="Open Time">{convertTime(open_time)}</TableCell>

        <TableCell data-label="Close Time">{convertTime(close_time)}</TableCell>
        ...
        <TableCell data-label="Market Status">
